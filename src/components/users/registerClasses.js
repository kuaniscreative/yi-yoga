...
const RegisterClasses = () => {
  const { step, toNextStep, toPrevStep } = useContext(registerClassContext);
...
//           }
//         });
//         const cellDatas = this.appendClassInfo(dateInfos, mappedClasses);
//         if (
...
//   firestoreConnect([{ collection: 'session' }, { collection: 'classProfile' }])
// )(RegisterClasses);
