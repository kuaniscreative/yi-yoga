  ...
  handleSubmit = (e) => {
    ...
    const sMonth =
      typeof this.state.start.month === 'number'
        ...
        : null;
    const eMonth =
      typeof this.state.end.month === 'number' ? this.state.end.month : null;
    const sYear =
      typeof this.state.start.year === 'number' ? this.state.start.year : null;
    const eYear =
      typeof this.state.end.year === 'number' ? this.state.end.year : null;
